...
import {img1,img2,img3,img4,img5,img6} from './mandalaDesignStores'


const MandalaDesignLandingPage = () => {
    useEffect(() => {
            window.scrollTo(0, 0)
        }, [])
    ...
    return (
          <div className="bg-white text-gray-800 font-serif ">
            ...
            <section className='md:ml-30 md:mr-30 ml-4 mr-4'>
                <h1 className='mt-10 font-black text-center text-4xl my-20 underline'>Welcome to Mandala Designs!</h1>
...
export default MandalaDesignLandingPage;