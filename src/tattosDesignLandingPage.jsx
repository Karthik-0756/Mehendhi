...
import { img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11 } from './tattosDesignStores'


const TattosDesignLandingPage = () => {
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    ...
    return (
        <div className="bg-white text-gray-800 font-serif ">
            ...
            <section className='md:ml-30 md:mr-30 ml-4 mr-4'>
                <h1 className='mt-10 font-black text-center text-4xl my-20 underline'>Welcome to Tattoo Designs!</h1>
...
export default TattosDesignLandingPage;